...
<aside class="sidebar" id="sidebar" aria-label="Site navigation">
  ...
  <div class="sidebar-footer-row">
    ...
    <!-- A LINK to /account/, deliberately not a second download button. The
         export is offered in exactly one place, which is the property bought
         by retiring the old /favorites/ export (§9ad) - a second button that
         downloads would give it back. This only solves discoverability:
         someone working in their library had no way of knowing an export
         existed. Hidden signed out, like Log out, since there is nothing to
         export without an account. -->
    <a href="/account/#export" id="nav-export-link" class="sidebar-signout sidebar-export" hidden>Export library</a>
    <button type="button" id="nav-signout-btn" class="sidebar-signout" hidden>Log out</button>
  </div>
