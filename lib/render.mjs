...
// supervisory authority, and England and Wales as the governing law. That
...
export const LEGAL_DETAILS = {
  entity: '[CONTROLLER NAME — your name or trading name]',
  email: '[CONTACT EMAIL]',
  address: '[POSTAL ADDRESS — or "available on request by email"]',
...
<div class="container legal-page">
  ...
  ${esc(d.entity)}. You can reach us at
  <a href="mailto:${esc(d.email)}">${esc(d.email)}</a>, or by post at
  ${esc(d.address)}. There is no Data Protection Officer; the service is small
  enough that one is not required.</p>
...
<div class="container legal-page">
  ...
  under English law. If you are a consumer, you have statutory rights that these
  ...
  England and Wales have jurisdiction. If you are a consumer resident elsewhere
  in the UK, you may bring proceedings in your own jurisdiction.</p>
