...
<div class="prompt-table-block" data-grid-id="${esc(gridId)}">
  ...
  <div class="table-wrap">
    <table class="browse-table comfortable">
      <thead>
        <tr><th class="col-select"><input type="checkbox" class="bulk-select-all" aria-label="Select all prompts"></th><th style="width:180px;">Category</th><th>Title</th><th class="col-updated">Updated</th><th class="col-actions"></th></tr>
      </thead>
