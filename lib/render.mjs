...
function personalizedActions(p, ctx) {
  ...
  return `
      ${btn('edit-id', 'Edit', 'Edit', ICON.edit)}${btn('duplicate-id', 'Duplicate', 'Duplicate — make an independent copy you can vary', ICON.copy)}${btn('archive-id', 'Archive', 'Archive — hides this prompt from your library, reversible', ICON.archive)}${btn('delete-id', 'Delete', 'Delete — permanently removes this prompt', ICON.trash)}`;
}
