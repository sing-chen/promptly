...
// Home (§9g) - the all-prompts table + live category/chain pills, replacing
// the old curated tile-grid/featured-rail/recently-added layout and folding
// in what the Browse hub used to do (that route is gone; category pages
// still exist individually at /browse/[category]/). Minimal hero (title +
// one-line framing stat) instead of a fuller marketing-style header - this
// is a personal tool, not a public landing page.
...
<div class="container">
  ...
  ${renderFilterToolbar([categoryGroup, chainGroup()], { id: 'home-filters', sort: true, resultCount: true })}
