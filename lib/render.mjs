...
<aside class="sidebar" id="sidebar" aria-label="Site navigation">
  ...
  <div class="sidebar-section">
    <div class="sidebar-section-label-row">
      ...
      <button type="button" id="manage-categories-btn" class="icon-btn sidebar-section-add" hidden aria-label="Manage categories" data-tip="Manage categories">${ICON.gear}</button>
    </div>
