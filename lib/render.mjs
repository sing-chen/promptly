...
<div class="container">
  <h1>Search</h1>
  <div id="search-results" data-state="empty">
    <p style="color:var(--ink-faint);">Start typing above to search prompts.</p>
  </div>
</div>`;
  return renderLayout({ title: 'Search', description: 'Search the prompt library.', active: 'search', bodyHtml: body });
}
