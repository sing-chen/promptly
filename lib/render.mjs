...
<div class="container legal-page">
  ...
  ${h('why')}
  <p>The first two rows apply to everyone. The rest apply only once you have an
  account — a contract is a basis we can only rely on where there is one, and
  browsing the site is not a contract.</p>
