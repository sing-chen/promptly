  ...
  <div class="sidebar-section">
    <div class="sidebar-section-label-row">
      ...
      <span class="sidebar-section-label-group">
        ...
        ${fieldInfo('collections-info-hint', 'Collections group your prompts for a project or workflow, so you can pull them all up at once.', {
          btnClass: 'sidebar-info-btn', hintClass: 'sidebar-info-hint', btnId: 'collections-info-btn',
          guest: { id: 'collections-info-guest', text: 'Log in to create one.' }
        })}
      </span>
  ...
  <div class="sidebar-section">
    <div class="sidebar-section-label-row">
      ...
      <span class="sidebar-section-label-group">
        ...
        ${fieldInfo('categories-info-hint', 'Categories sort your prompts — rename them, pick their colours, add ones that fit how you work.', {
          ...
          // is one.
          guest: { id: 'categories-info-guest', text: 'Browsing uses the shared set; log in to get your own.' }
        })}
      </span>
